...
public class Serializer {
	public static void main(String[] args) {
		...
		Address address = new Address("Rua Jos ́e", 20, "Por do Sol", "37.130-000", "Machado", "MG");
		Person emerson = new Person("Guilherme Henrique", "060.793.477-11", new Date(), address);
		try {
